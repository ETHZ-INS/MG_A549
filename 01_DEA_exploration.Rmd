...
for(f in names(res)){
  rowData(se)[[paste0("DEA.",f)]] <- 
    plgINS2::dround(res[[f]][row.names(se),c(1,2,4,5)], 2, TRUE)
}
...
rowData(se)$DEA.inhibition <- plgINS2::dround(res[row.names(se),c(1,4,5)], 2, TRUE)
...
rowData(se)$DEA.KHonly <- plgINS2::dround(res[row.names(se),c(1,4,5)], 2, TRUE)
...
rowData(se)$DEA.otherInhibs <- plgINS2::dround(res[row.names(se),c(1,4,5)], 2, TRUE)
...
rowData(se)$DEA.inhibited.prior <- plgINS2::dround(res[row.names(se),c(1,4,5)], 2, TRUE)
...
rowData(se)[["DEA.inhibited by others.prior"]] <- plgINS2::dround(res[row.names(se),c(1,4,5)], 2, TRUE)
...
rowData(se)$DEA.inhibited.after <- plgINS2::dround(res[row.names(se),c(1,4,5)], 2, TRUE)
